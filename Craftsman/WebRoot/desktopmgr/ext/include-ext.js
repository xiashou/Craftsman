...
(function() {
    ...
    if (includeCSS) {
        document.write('<link rel="stylesheet" type="text/css" href="' + path + '/resources/ext/resources/css/ext-all' + suffix + '-debug.css"/>');
        document.write('<link rel="stylesheet" type="text/css" href="' + path + '/resources/css/icon.css"/>');
    }
    document.write('<script type="text/javascript" src="' + path + '/resources/ext/ext-all' + (rtl ? '-rtl' : '') + '.js"></script>');
    ...
    if (neptune) {
        ...
        neptunePath = (repoDevMode ? path + '/..' : path) +
            '/resources/ext/ext-theme-neptune' +
            (repoDevMode ? '-dev' : '') + '.js';
