...
<title>智能工匠 - Desktop Sample App</title>
    ...
    <link rel="stylesheet" type="text/css" href="<%=basePath %>/desktopmgr/css/desktop.css" />

    <script type="text/javascript" src="<%=basePath %>/desktopmgr/ext/include-ext.js"></script>
    <script type="text/javascript" src="<%=basePath %>/resources/ext/locale/ext-lang-zh_CN.js"></script>
    <script type="text/javascript">
        Ext.Loader.setPath({
            'Ext.ux.desktop': '/desktopmgr/ux',
            MyDesktop: '/desktopmgr/frame'
        });
