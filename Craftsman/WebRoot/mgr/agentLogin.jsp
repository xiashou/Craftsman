...
<body ontouchstart>
	<div class="right">
		<div class="login">
			...
			<div class="input">
				<input type="text" id="agentName" placeholder="用户名">
...
document.getElementById("agentName").onkeydown=function(event){
...
function login() {
	...
	if(Ext.isEmpty(agentName.value)){
		Ext.MessageBox.show({
			title: '提示',
			msg: "用户名不能为空！",
	...
	Ext.Ajax.request({
        ...
        url: '/agentLogin.atc',
        params : {
        	'sysAgent.agentName' : agentName.value,
        	'sysAgent.password' : password.value
		},
		success : function(resp, opts) {
			...
			if(result.success){
				...
				setCookie("agent.agentName", agentName.value, 240);
				window.location.href = '/aindex.atc';
			} else {
				Ext.MessageBox.show({
		           title: '提示',
		           msg: result.msg,
