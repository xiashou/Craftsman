...
<body>
	...
	<div id="div_main">
		<table>
	        ...
	        <tr>
	            <th><div style="font-size:16px;">退货单</div></th>
	        </tr>
	    </table>
	    <table style="margin-top:8px;">
	        <tr>
	            <td width="25%">退货日期：<s:property value="inNumber.substring(0,4)" />年<s:property value="inNumber.substring(4,6)" />月<s:property value="inNumber.substring(6,8)" />日</td>
	            <td width="25%"></td>
	            <td width="25%"></td>
	            <td width="25%"></td>
	        </tr>
