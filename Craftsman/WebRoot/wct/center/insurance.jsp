    ...
    <div class="container" id="container">
    	<div class="page__bd">
    		<div class="weui-cells__title title_bg">
    			<div class="text">保险到期设定</div>
    		</div>
    		<div class="weui-cells weui-cells_form">
	            <div class="weui-cell">
	                <div class="weui-cell__hd"><label for="" class="weui-label">保险时间</label></div>
	                <div class="weui-cell__bd">
	                    <input id="carInsurance" class="weui-input" type="date" value=""/>
	                </div>
	            </div>
	        </div>
        	...
        	if(type == 'edit') {//修改，如果进行修改则初始化被修改车辆信息
    	     	...
    	     	$.ajax({
    	    	    ...
    	    	    success: function(data){
    	    	    	var date = data.car.carInsurance.replace(/\//g, "-");
    	    	    	$("#carInsurance").val(date);
    	    	    },
	    ...
	    function save() {
	    	...
	    	$.ajax({
	    	    type: 'POST',
	 	   	    data: {
	 	   	    	'car.id' : carId,
	 	   	    	'car.carInsurance' : $("#carInsurance").val()
	 	 		},
