...
<script type="text/javascript">	
	...
	$(function(){
	    $.ajax({
			type:'post',
			url:  '<%=basePath %>/open/wechat/jssdk/getJSSDKParams.atc?sid=<%=sid %>',
			data: {
    			'wxConfig.url' : url
    		},
			dataType: 'json',
			...
			success: function(data){
				...
				wx.config({
				    ...
				    jsApiList: ['getLocation', 'openLocation', 'onMenuShareTimeline', 'onMenuShareAppMessage'] // 必填，需要使用的JS接口列表，所有JS接口列表见附录2
				});
