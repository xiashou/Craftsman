...
public final class OAuthToken implements Serializable {
    ...
    public OAuthToken(String component_access_token, int expiresIn) {
        this.component_access_token = component_access_token;
        setExpires_in(expiresIn);
    }

    public OAuthToken(String component_access_token, int expiresIn, long createTime) {
        this.component_access_token = component_access_token;
    ...
    public OAuthToken(JSONObject jsonObj) throws WeixinException {
        this.component_access_token = jsonObj.getString("component_access_token");
    ...
    public String toString() {
        //对外的时间 需要加上扣掉的 60秒
        return "{\"component_access_token\":\"" + this.getAccess_token() + "\",\"expires_in\":" + this.getExpires_in() + ",\"create_time\" : " + this.getCreate_time() + "}";
    }
}
