package org.weixin4j.message.template.OPENTM203424414;

import org.weixin4j.message.template.BaseTemplate;

import com.tcode.core.util.Utils;

public class OPENTM203424414 extends BaseTemplate {
	 ...
	 */
	public OPENTM203424414(String first, String time, String money, String type, String give,
			String balance, String remark,String color) {
		...
		String value = "{\"first\": {\"value\":\"FIRST\",\"color\":\"COLOR\"},"
				...
				+ "\"keyword4\":{\"value\":\"GIVE\",\"color\":\"COLOR\"},"
				+ "\"keyword5\":{\"value\":\"BANLANCE\",\"color\":\"COLOR\"},"
				+ "\"remark\":{\"value\":\"REMARK\",\"color\":\"COLOR\"}}";
		value = value.replace("FIRST", first).replace("TIME", time).replace("MONEY", money)
				.replace("TYEP", type).replace("GIVE", give).replace("BANLANCE", balance)
