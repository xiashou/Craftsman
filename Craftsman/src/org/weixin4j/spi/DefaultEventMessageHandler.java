...
import com.tcode.business.wechat.sys.util.WechatAttentionAuthorizerUtil;
...
public class DefaultEventMessageHandler implements IEventMessageHandler {
    ...
    public OutputMessage subscribe(SubscribeEventMessage msg) {
    	//初始化关注信息
    	try {
			WechatAttentionAuthorizerUtil.initWechatAttentionAuthorizer(msg);
		} catch (Exception e) {
			e.printStackTrace();
		}
